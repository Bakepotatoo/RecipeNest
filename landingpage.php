  ...
  <header class="p-3 " style="background-color: var(--header-color)">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav class="d-flex gap-3">
        ...
        <button type="button" class="btn btn-custom" data-bs-toggle="modal" data-bs-target="#logInModal">
          LogIn
        </button>
      </nav>
      ...
      <div class="modal" id="logInModal">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
              <form id="logInForm" method="POST" action="controller2.php">
                <input type="hidden" name="page" value="LandingPage">
                ...
                <div class="modal-footer">
                  <button type="submit" id="submit-login" class="btn btn-success" data-bs-dismiss="modal">Submit</button>
                </div>
              </form>
            </div>
          </div>
